    ...
    <table className="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td contentEditable="true" className="editable_airportID_1">VVCS</td>
          <td contentEditable="true" className="editable_airportName_1">Sân bay Côn Đảo</td>
          <td contentEditable="true" className="editable_place_1">Bà Rịa - Vũng Tàu</td>
        </tr>
        <tr>
          <td contentEditable="true" className="choose">
            <input className="form-check-input" type="checkbox" />
