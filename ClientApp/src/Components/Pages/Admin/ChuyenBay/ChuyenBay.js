          ...
          <table className="table table-bordered">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td contentEditable="true" className="editable_flyID_1">F001</td>
                <td contentEditable="true" className="editable_Pl_ID_1">PL01</td>
                <td contentEditable="true" className="editable_fromLocation_1">Hà Nội</td>
                <td contentEditable="true" className="editable_toLocation_1">Bà Rịa-Vũng Tàu</td>
                <td contentEditable="true" className="editable_departureTime_1">08:00</td>
                <td contentEditable="true" className="editable_arrivalTime_1">10:00</td>
                <td contentEditable="true" className="editable_departureDay_1">2023-12-01</td>
              </tr>
              <tr>
                <td contentEditable="true" className="choose">
                  <input className="form-check-input" type="checkbox" />
