    ...
    <table className="table table-bordered">
      ...
      <tbody>
        ...
        <tr>
          ...
          <td contentEditable="true" className="editable_LUGGAGE_CODE_1">FD01</td>
          <td contentEditable="true" className="editable_MASS_1">Bữa sáng ấm áp</td>
          <td contentEditable="true" className="editable_PRICE_1">150000</td>
        </tr>
        <tr>
          <td contentEditable="true" className="choose">
            <input className="form-check-input" type="checkbox" />
